...
generator_mapping = [(fields_containing_dates, generators.date_generator),
                     ...
                     (fields_containing_when, generators.placeholder_generator),
...
if demo_data:
    ...
    for i in range(25):
        ...
        for _ in range(4):
            value = generators.other_value(selection[1], field)
            demo_field.append(field)
            demo_value.append(value)
            demo_label.append(0)
